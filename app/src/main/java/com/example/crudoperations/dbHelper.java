...
public class dbHelper extends SQLiteOpenHelper {
    ...
    public void deleteStudent(Student STUDENTModel)
    {
        ...
        long recremove =db.delete(STUDENT_TABLE,"StudentName='"+STUDENTModel.getName()+"'",null);
        if (recremove != -1) {
    ...
    public void updateStudent(Student STUDENTModel)
    {
        ...
        cv.put(STUDENT_ROLL, STUDENTModel.getRollNmber());
        cv.put(STUDENT_ENROLL, STUDENTModel.isEnroll());
        long upid = db.update(STUDENT_TABLE,cv,"StudentName='"+STUDENTModel.getName()+"'",null);
        if(upid != -1)
        {
